...
using ExpressiveAnnotations.DotNetCore.Analysis;
using ExpressiveAnnotations.DotNetCore.Functions;
using Microsoft.AspNetCore.Mvc.ModelBinding.Validation;

namespace ExpressiveAnnotations.DotNetCore.Attributes
{
    /// <summary>
    ...
    public abstract class ExpressiveAttribute : ValidationAttribute //, IClientModelValidator
    {
        ...
        //#region IClientModelValidator

        //public void AddValidation(ClientModelValidationContext context)
        //{
        //    var ruleName = GetClientRuleName();

        //    MergeAttribute(context.Attributes, "data-val", "true");
        //    MergeAttribute(context.Attributes, $"data-val-{ruleName}", FormattedErrorMessage);

        //    MergeAttribute(context.Attributes, "data-val-expression", Expression.ToJson());

        //    if (AllowEmpty.HasValue)
        //    {
        //        MergeAttribute(context.Attributes, "data-val-allowempty", AllowEmpty.Value.ToJson());
        //    }
        //}

        //protected abstract string GetClientRuleName();
